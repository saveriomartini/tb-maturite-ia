  ...
  <AppScreen class="info">
    <header class="page-head">
      ...
      <p class="page-head__lead">
        Rien de ce qui suit n'est requis pour commencer : le diagnostic se conduit sans l'avoir lu.
        Cette page est là pour qui veut comprendre d'où viennent les questions.
      </p>
    </header>
    ...
    <section class="zone">
      <h2 class="zone__title heading">Les areas retenues pour le diagnostic</h2>
      <ScreenDiagStart :vm="scope" />
    </section>

    <AppScreenNav back-label="Retour à l'accueil" @back="emit('back')">
      <template #actions>
        <button type="button" class="btn btn-primary info__start" @click="emit('start')">
